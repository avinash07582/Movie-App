...
const Movies = () => {
    ...
    document.title = "CinePulse|Movies" 
  ...
  return movie.length>0 ? (
    ...
    <div className=" px-[6%]  w-full   flex items-center justify-between">
     ...
     <h1 className='  text-2xl font-semibold
      text-zinc-400'><i   onClick={()=> navigate(-1)} class="  hover:text-[#6556CD]  ri-arrow-left-line"></i>Movie
    ...
    next={GetMovie}    hasMore ={hasMore}  loader ={<h1>Loading...</h1>}>
